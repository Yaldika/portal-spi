                ...
                <div class="card full-height">
                    <div class="card-header">
                        <div class="card-head-row">
                            <div class="card-title">Edit Artikel {{ $artikel->judul }}
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('artikel.update', $artikel->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="body" id="editor1" class="form-control">{{ $artikel->body }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <img src=" {{ asset('storage/' . $artikel->gambar_artikel) }} " width="100">
                            </div>
                            <div class="form-group">
